...
export const sk_usahaPlain = t.Object(
  {
    id: t.String(),
    name: t.String(),
    born_birth: t.Date(),
...
export const sk_usahaRelations = t.Object(
  {
...
export const sk_usahaPlainInputCreate = t.Object(
  {
    name: t.String(),
    born_birth: t.Date(),
    born_place: t.String(),
...
export const sk_usahaPlainInputUpdate = t.Object(
  {
    ...
    bussiness: t.Optional(t.String()),
    reason: t.Optional(t.String()),
  },
  { additionalProperties: false },
);

export const sk_usahaRelationsInputCreate = t.Object(
  {
    user_sk: t.Optional(
      t.Object(
        {
...
export const sk_usahaRelationsInputUpdate = t.Partial(
  t.Object(
    {
      user_sk: t.Partial(
        t.Object(
...
export const sk_usahaWhere = t.Partial(
  t.Recursive(
    (Self) =>
      t.Object(
        {
...
export const sk_usahaWhereUnique = t.Recursive(
  (Self) =>
    t.Intersect(
      [
        t.Partial(
...
export const sk_usahaSelect = t.Partial(
  t.Object(
    {
      id: t.Boolean(),
      name: t.Boolean(),
...
export const sk_usahaInclude = t.Partial(
  t.Object(
    {
      gender: t.Boolean(),
      marital_status: t.Boolean(),
...
export const sk_usahaOrderBy = t.Partial(
  t.Object(
    {
      ...
      bussiness: t.Union([t.Literal("asc"), t.Literal("desc")], {
        additionalProperties: false,
      }),
...
export const sk_usaha = t.Composite([sk_usahaPlain, sk_usahaRelations], {
  additionalProperties: false,
});

export const sk_usahaInputCreate = t.Composite(
  [sk_usahaPlainInputCreate, sk_usahaRelationsInputCreate],
  { additionalProperties: false },
);

export const sk_usahaInputUpdate = t.Composite(
  [sk_usahaPlainInputUpdate, sk_usahaRelationsInputUpdate],
  { additionalProperties: false },
);
