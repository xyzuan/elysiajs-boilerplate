...
export const sk_domisiliPlain = t.Object(
  {
    id: t.String(),
    name: t.String(),
    born_birth: t.Date(),
...
export const sk_domisiliRelations = t.Object(
  {
...
export const sk_domisiliPlainInputCreate = t.Object(
  {
    name: t.String(),
    born_birth: t.Date(),
    born_place: t.String(),
...
export const sk_domisiliPlainInputUpdate = t.Object(
  {
...
export const sk_domisiliRelationsInputCreate = t.Object(
  {
    user_sk: t.Optional(
      t.Object(
        {
...
export const sk_domisiliRelationsInputUpdate = t.Partial(
  t.Object(
    {
      user_sk: t.Partial(
        t.Object(
...
export const sk_domisiliWhere = t.Partial(
  t.Recursive(
    (Self) =>
      t.Object(
        {
...
export const sk_domisiliWhereUnique = t.Recursive(
  (Self) =>
    t.Intersect(
      [
        t.Partial(
...
export const sk_domisiliSelect = t.Partial(
  t.Object(
    {
      id: t.Boolean(),
      name: t.Boolean(),
...
export const sk_domisiliInclude = t.Partial(
  t.Object(
    {
      gender: t.Boolean(),
      marital_status: t.Boolean(),
...
export const sk_domisiliOrderBy = t.Partial(
  t.Object(
    {
...
export const sk_domisili = t.Composite(
  [sk_domisiliPlain, sk_domisiliRelations],
  { additionalProperties: false },
);

export const sk_domisiliInputCreate = t.Composite(
  [sk_domisiliPlainInputCreate, sk_domisiliRelationsInputCreate],
  { additionalProperties: false },
);

export const sk_domisiliInputUpdate = t.Composite(
  [sk_domisiliPlainInputUpdate, sk_domisiliRelationsInputUpdate],
  { additionalProperties: false },
);
